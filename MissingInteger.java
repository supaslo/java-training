...
class MissingInteger {
    public static void main(String[] args) {
        ...
        System.out.println("Missing Number for Test 1 is:  " + findLowestNumberNotFound(intArray1));
        System.out.println("Missing Number for Test 2 is:  " + findLowestNumberNotFound(intArray2));
        System.out.println("Missing Number for Test 3 is:  " + findLowestNumberNotFound(intArray3));
    }
